    ...
    <footer className="w-screen bg-gradient-to-b from-[#5542ff] to-[#b59cff] pt-16 pb-8 text-black px-6 sm:px-12 md:px-20 lg:px-28">
      <div className="flex flex-col md:flex-row justify-between items-start gap-10 w-full">
        ...
        <div className="md:w-1/4 flex flex-col items-start">
          <img
            src="/img/RIS logo 10x10.png"
            alt="RIS Logo"
            className="h-48 md:h-[250px] w-auto object-contain select-none mb-3"
          />

          {/* Contact Details */}
          <div className="space-y-2.5 font-general text-[12px] text-black font-semibold mt-3">
            <a
              href="tel:+918291609368"
              className="flex items-center gap-2 hover:opacity-70 transition-opacity duration-300"
            >
              <FiPhone className="text-black size-4" />
              <span>+91-8291609368</span>
            </a>
            <a
              href="mailto:rismr@rahuleducation.com"
              className="flex items-center gap-2 hover:opacity-70 transition-opacity duration-300 break-all"
            >
              <FiMail className="text-black size-4" />
        ...
        {/* Links Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 md:gap-10 w-full md:w-3/4">
          {/* About Us Column */}
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#cbse"
                  className="group font-circular-web text-[15px] xl:text-[16px] font-medium text-black transition-all duration-300 hover:bg-black hover:text-[#5542ff] hover:-rotate-[2deg] hover:scale-105 inline-flex items-center gap-1 px-2.5 py-0.5 -ml-2.5 rounded-md w-fit"
                >
                  <span>CBSE</span>
            ...
            <div className="mt-8 flex flex-col gap-2.5">
              <span className="font-general text-[11px] uppercase tracking-[0.2em] text-black mb-1 block font-semibold">
                Downloads
              </span>
              <a
                href="#app-store"
      ...
      {/* Footer Bottom Bar */}
      <div className="mt-20 flex flex-col sm:flex-row justify-between items-center gap-4 w-full">
        <span className="font-general text-[10px] font-bold uppercase tracking-wider text-black text-center sm:text-left select-none">
          ©RIS 2026. ALL RIGHTS RESERVED
        </span>
        <a
          href="#privacy-policy"
          className="font-general text-[10px] font-bold uppercase tracking-wider text-black hover:opacity-70 transition-opacity duration-300"
        >
          PRIVACY POLICY
        </a>
      </div>
